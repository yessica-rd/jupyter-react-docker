...
exports.List = exports.DefaultStyleController = exports.MouseController = exports.isSelectionRangeChangeEvent = exports.isSelectionSingleChangeEvent = exports.DefaultKeyboardNavigationDelegate = exports.TypeNavigationMode = exports.isButton = exports.isMonacoEditor = exports.isInputElement = void 0;
...
})(TypeNavigationMode = exports.TypeNavigationMode || (exports.TypeNavigationMode = {}));
...
class TypeNavigationController {
    ...
    enable() {
        ...
        const onChar = this.enabledDisposables.add(event_2.Event.chain(this.enabledDisposables.add(new event_1.DomEmitter(this.view.domNode, 'keydown')).event))
            ...
            .event;
        const onClear = event_2.Event.debounce(onChar, () => null, 800, undefined, undefined, this.enabledDisposables);
...
const defaultStyles = {
    ...
    listFocusAndSelectionOutline: color_1.Color.fromHex('#90C2F9'),
