...
class ActionWithDropdownActionViewItem extends actionViewItems_1.ActionViewItem {
    ...
    render(container) {
        ...
        if (this.element) {
            ...
            this.dropdownMenuActionViewItem = new DropdownMenuActionViewItem(this._register(new actions_1.Action('dropdownAction', nls.localize('moreActions', "More Actions..."))), menuActionsProvider, this.contextMenuProvider, { classNames: ['dropdown', ...codicons_1.Codicon.dropDownButton.classNamesArray, ...menuActionClassNames] });
