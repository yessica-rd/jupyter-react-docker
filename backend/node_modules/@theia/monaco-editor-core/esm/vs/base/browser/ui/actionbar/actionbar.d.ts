...
import { IHoverDelegate } from '../iconLabel/iconHoverDelegate';
...
export declare class ActionBar extends Disposable implements IActionRunner {
    ...
    private _actionRunnerDisposables;
    private _context;
    private readonly _orientation;
    private readonly _triggerKeys;
    viewItems: IActionViewItem[];
    private viewItemDisposables;
    ...
    private _onWillRun;
    readonly onWillRun: import("../../../common/event").Event<IRunEvent>;
