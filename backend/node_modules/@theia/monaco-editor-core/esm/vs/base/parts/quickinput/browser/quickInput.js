...
const toggle_1 = require("../../../browser/ui/toggle/toggle");
...
class QuickPick extends QuickInput {
    ...
    set toggles(toggles) {
        ...
        const concreteToggles = toggles === null || toggles === void 0 ? void 0 : toggles.filter(opts => opts instanceof toggle_1.Toggle);
