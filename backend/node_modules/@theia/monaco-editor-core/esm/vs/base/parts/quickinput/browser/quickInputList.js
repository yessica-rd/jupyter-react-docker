...
exports.matchesContiguousIconAware = exports.QuickInputList = exports.QuickInputListFocus = void 0;
        ...
        // Filter by value (since we support icons in labels, use $(..) aware fuzzy matching)
            ...
            this.elements.forEach(element => {
                ...
                if (this.matchOnLabelMode === 'fuzzy') {
                    labelHighlights = this.matchOnLabel ? (0, types_1.withNullAsUndefined)((0, iconLabels_1.matchesFuzzyIconAware)(query, (0, iconLabels_1.parseLabelWithIcons)(element.saneLabel))) : undefined;
                }
                else {
                    labelHighlights = this.matchOnLabel ? (0, types_1.withNullAsUndefined)(matchesContiguousIconAware(queryWithWhitespace, (0, iconLabels_1.parseLabelWithIcons)(element.saneLabel))) : undefined;
                }
...
exports.matchesContiguousIconAware = matchesContiguousIconAware;
