...
const blockDecorations_1 = require("./viewParts/blockDecorations/blockDecorations");
class View extends viewEventHandler_1.ViewEventHandler {
    ...
    _getEditorClassName() {
        ...
        return this._context.configuration.options.get(130 /* EditorOption.editorClassName */) + ' ' + (0, themeService_1.getThemeTypeSelector)(this._context.theme.type) + focused;
    }
