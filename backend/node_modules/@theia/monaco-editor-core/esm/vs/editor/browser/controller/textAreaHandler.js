...
class TextAreaHandler extends viewPart_1.ViewPart {
            ...
            getScreenReaderContent: (currentState) => {
                if (this._accessibilitySupport === 1 /* AccessibilitySupport.Disabled */) {
                    ...
                    if (platform.isMacintosh && !selection.isEmpty() && simpleModel.getValueLengthInRange(selection) < LIMIT_CHARS) {
                        ...
                        return new textAreaState_1.TextAreaState(text, 0, text.length, selection.getStartPosition(), selection.getEndPosition());
                    }
    ...
    _getWordBeforePosition(position) {
        const lineContent = this._context.viewModel.getLineContent(position.lineNumber);
        const wordSeparators = (0, wordCharacterClassifier_1.getMapForWordSeparators)(this._context.configuration.options.get(119 /* EditorOption.wordSeparators */));
