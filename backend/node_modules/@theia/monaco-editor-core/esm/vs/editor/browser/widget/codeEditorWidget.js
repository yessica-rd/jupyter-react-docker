...
let CodeEditorWidget = class CodeEditorWidget extends lifecycle_1.Disposable {
    ...
    getConfiguredWordAtPosition(position) {
        ...
        return cursorWordOperations_1.WordOperations.getWordAtPosition(this._modelData.model, this._configuration.options.get(119 /* EditorOption.wordSeparators */), position);
    }
    ...
    setHiddenAreas(ranges, source) {
        var _a;
        (_a = this._modelData) === null || _a === void 0 ? void 0 : _a.viewModel.setHiddenAreas(ranges.map(r => range_1.Range.lift(r)), source);
    }
