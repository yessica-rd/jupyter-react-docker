            ...
            try {
                ...
                if (items.length > 0) {
                    ...
                    if (positionToEnclose && query.original.length === 0) {
                        const candidate = (0, arrays_1.findLast)(items, item => Boolean(item.type !== 'separator' && item.range && range_1.Range.containsPosition(item.range.decoration, positionToEnclose)));
                        if (candidate) {
