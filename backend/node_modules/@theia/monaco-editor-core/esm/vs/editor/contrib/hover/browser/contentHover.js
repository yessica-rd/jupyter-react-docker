...
let ContentHoverController = class ContentHoverController extends lifecycle_1.Disposable {
    ...
    startShowingAtRange(range, mode, focus) {
        this._startShowingOrUpdateHover(new hoverTypes_1.HoverRangeAnchor(0, range, undefined, undefined), mode, focus, null);
    }
    /**
     * Returns true if the hover shows now or will show.
     */
    ...
    static computeHoverRanges(anchorRange, messages) {
        ...
        return {
            showAtPosition: forceShowAtRange ? forceShowAtRange.getStartPosition() : new position_1.Position(anchorRange.startLineNumber, renderStartColumn),
            showAtRange: forceShowAtRange ? forceShowAtRange : new range_1.Range(anchorLineNumber, renderStartColumn, anchorLineNumber, renderEndColumn),
            highlightRange
        };
    }
};
