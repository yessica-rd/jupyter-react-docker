...
export declare class ParameterHintsModel extends Disposable {
    ...
    readonly onChangedHints: import("../../../../base/common/event").Event<languages.SignatureHelp | undefined>;
...
//# sourceMappingURL=parameterHintsModel.d.ts.map