...
import { InlayHintItem } from './inlayHints';
...
declare const IInlayHintsCache: import("../../../../platform/instantiation/common/instantiation").ServiceIdentifier<IInlayHintsCache>;
