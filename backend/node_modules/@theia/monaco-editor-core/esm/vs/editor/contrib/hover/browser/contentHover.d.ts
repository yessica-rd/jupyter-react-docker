...
import { IEditorHoverColorPickerWidget, IHoverPart } from './hoverTypes';
...
export declare class ContentHoverController extends Disposable {
    ...
    static computeHoverRanges(anchorRange: Range, messages: IHoverPart[]): {
...
declare class ContentHoverVisibleData {
    ...
    constructor(colorPicker: IEditorHoverColorPickerWidget | null, showAtPosition: Position, showAtRange: Range, preferAbove: boolean, stoleFocus: boolean, isBeforeContent: boolean, initialMousePosX: number | undefined, initialMousePosY: number | undefined, disposables: DisposableStore);
}
