...
let CodeActionUi = class CodeActionUi extends lifecycle_1.Disposable {
    constructor(_editor, quickFixActionId, preferredFixActionId, delegate, _configurationService, _contextKeyService, _instantiationService) {
        ...
        this._lightBulbWidget = new lazy_1.Lazy(() => {
            const widget = this._register(_instantiationService.createInstance(lightBulbWidget_1.LightBulbWidget, this._editor, quickFixActionId, preferredFixActionId));
        ...
        this._register(this._editor.onDidLayoutChange(() => { var _a; return (_a = codeActionWidget_1.CodeActionWidget.INSTANCE) === null || _a === void 0 ? void 0 : _a.hide(); }));
    }
    dispose() {
    ...
    update(newState) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (newState.trigger.type === 1 /* CodeActionTriggerType.Invoke */) {
                ...
                if ((_f = codeActionWidget_1.CodeActionWidget.INSTANCE) === null || _f === void 0 ? void 0 : _f.isVisible) {
    ...
    showCodeActionList(trigger, actions, at, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            codeActionWidget_1.CodeActionWidget.getOrCreateInstance(this._instantiationService).show(trigger, actions, anchor, editorDom, Object.assign(Object.assign({}, options), { showHeaders: this.shouldShowHeaders() }), {
