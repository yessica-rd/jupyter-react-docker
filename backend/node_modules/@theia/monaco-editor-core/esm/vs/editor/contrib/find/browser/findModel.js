...
const textModelSearch_1 = require("../../../common/model/textModelSearch");
const findDecorations_1 = require("./findDecorations");
const replaceAllCommand_1 = require("./replaceAllCommand");
const replacePattern_1 = require("./replacePattern");
...
class FindModelBoundToEditorModel {
    ...
    _largeReplaceAll() {
        const searchParams = new textModelSearch_1.SearchParams(this._state.searchString, this._state.isRegex, this._state.matchCase, this._state.wholeWord ? this._editor.getOption(119 /* EditorOption.wordSeparators */) : null);
