...
import { IModelContentChangedEvent, IModelDecorationsChangedEvent, IModelOptionsChangedEvent, InternalModelContentChangeEvent, ModelInjectedTextChangedEvent } from '../textModelEvents';
import { IGuidesTextModelPart } from '../textModelGuides';
import { ITokenizationTextModelPart } from '../tokenizationTextModelPart';
import { IColorTheme, ThemeColor } from '../../../platform/theme/common/themeService';
...
export declare class TextModel extends Disposable implements model.ITextModel, IDecorationsTreesHost {
    ...
    get onDidChangeLanguage(): Event<import("../textModelEvents").IModelLanguageChangedEvent>;
    get onDidChangeLanguageConfiguration(): Event<import("../textModelEvents").IModelLanguageConfigurationChangedEvent>;
    get onDidChangeTokens(): Event<import("../textModelEvents").IModelTokensChangedEvent>;
...
export declare class DidChangeDecorationsEmitter extends Disposable {
    ...
    private _affectedInjectedTextLines;
    constructor(handleBeforeFire: (affectedInjectedTextLines: Set<number> | null) => void);
    hasListeners(): boolean;
    beginDeferredEmit(): void;
    endDeferredEmit(): void;
    recordLineAffectedByInjectedText(lineNumber: number): void;
