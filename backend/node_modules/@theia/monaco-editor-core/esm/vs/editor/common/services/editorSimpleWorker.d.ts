...
import { IDiffComputationResult, IUnicodeHighlightsResult } from './editorWorker';
import { IEditorWorkerHost } from './editorWorkerHost';
import { UnicodeHighlighterOptions } from './unicodeTextModelHighlighter';
import { IChange } from '../diff/smartLinesDiffComputer';
...
export declare class EditorSimpleWorker implements IRequestHandler, IDisposable {
    ...
    computeDiff(originalUrl: string, modifiedUrl: string, options: IDocumentDiffProviderOptions): Promise<IDiffComputationResult | null>;
