...
export declare function setDefaultGetWordAtTextConfig(value: IGetWordAtTextConfig): import("../../../base/common/lifecycle").IDisposable;
...
//# sourceMappingURL=wordHelper.d.ts.map