...
export declare class LanguageFeaturesService implements ILanguageFeaturesService {
    ...
    readonly inlineCompletionsProvider: LanguageFeatureRegistry<InlineCompletionsProvider<import("../languages").InlineCompletions<import("../languages").InlineCompletion>>>;
...
//# sourceMappingURL=languageFeaturesService.d.ts.map