...
class ViewModelDecorations {
    ...
    _getDecorationsInRange(viewRange, onlyMinimapDecorations) {
        const modelDecorations = this._linesCollection.getDecorationsInRange(viewRange, this.editorId, (0, editorOptions_1.filterValidationDecorations)(this.configuration.options), onlyMinimapDecorations);
