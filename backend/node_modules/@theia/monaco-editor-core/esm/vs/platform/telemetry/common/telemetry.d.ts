...
import { IObservableValue } from '../../../base/common/observableValue';
...
export declare const ICustomEndpointTelemetryService: import("../../instantiation/common/instantiation").ServiceIdentifier<ICustomEndpointTelemetryService>;
