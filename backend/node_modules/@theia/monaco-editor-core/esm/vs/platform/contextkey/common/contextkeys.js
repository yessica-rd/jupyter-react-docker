...
exports.IsMobileContext = new contextkey_1.RawContextKey('isMobile', platform_1.isMobile, (0, nls_1.localize)('isMobile', "Whether the platform is a mobile web browser"));
exports.IsDevelopmentContext = new contextkey_1.RawContextKey('isDevelopment', false, true);
exports.ProductQualityContext = new contextkey_1.RawContextKey('productQualityType', '', (0, nls_1.localize)('productQualityType', "Quality type of VS Code"));
