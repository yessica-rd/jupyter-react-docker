...
import { IQuickInputOptions, QuickInputController } from '../../../base/parts/quickinput/browser/quickInput';
...
import { IInputBox, IInputOptions, IKeyMods, IPickOptions, IQuickInputButton, IQuickInputService, IQuickNavigateConfiguration, IQuickPick, IQuickPickItem, QuickPickInput } from '../common/quickInput';
...
export declare class QuickInputService extends Themable implements IQuickInputService {
    ...
    readonly onShow: import("../../../base/common/event").Event<void>;
    private readonly _onHide;
    readonly onHide: import("../../../base/common/event").Event<void>;
    private _controller;
