...
exports.defaultListStyles = {
    ...
    listFocusAndSelectionOutline: colorRegistry_1.listFocusAndSelectionOutline,
    ...
    listFilterWidgetShadow: colorRegistry_1.listFilterWidgetShadow,
    ...
    inputActiveOptionBorder: colorRegistry_1.inputActiveOptionBorder,
    inputActiveOptionForeground: colorRegistry_1.inputActiveOptionForeground,
    inputActiveOptionBackground: colorRegistry_1.inputActiveOptionBackground,
...
function attachButtonStyler(widget, themeService, style) {
    return attachStyler(themeService, {
        ...
        buttonSeparator: (style === null || style === void 0 ? void 0 : style.buttonSeparator) || colorRegistry_1.buttonSeparator,
...
exports.defaultDialogStyles = {
    ...
    buttonSeparator: colorRegistry_1.buttonSeparator,
