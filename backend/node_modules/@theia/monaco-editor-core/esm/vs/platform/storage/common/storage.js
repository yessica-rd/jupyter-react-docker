...
exports.logStorage = exports.InMemoryStorageService = exports.isProfileUsingDefaultStorage = exports.AbstractStorageService = exports.loadKeyTargets = exports.WillSaveStateReason = exports.IStorageService = exports.TARGET_KEY = exports.IS_NEW_KEY = void 0;
...
const userDataProfile_1 = require("../../userDataProfile/common/userDataProfile");
    ...
    updateKeyTarget(key, scope, target) {
        ...
        if (typeof target === 'number') {
            if (keyTargets[key] !== target) {
                ...
                (_a = this.getStorage(scope)) === null || _a === void 0 ? void 0 : _a.set(exports.TARGET_KEY, JSON.stringify(keyTargets));
            }
        }
        // Remove
        else {
            if (typeof keyTargets[key] === 'number') {
                ...
                (_b = this.getStorage(scope)) === null || _b === void 0 ? void 0 : _b.set(exports.TARGET_KEY, JSON.stringify(keyTargets));
            }
        }
    }
...
function isProfileUsingDefaultStorage(profile) {
    var _a;
    return profile.isDefault || !!((_a = profile.useDefaultFlags) === null || _a === void 0 ? void 0 : _a.uiState);
}
...
class InMemoryStorageService extends AbstractStorageService {
    constructor() {
        super();
        this.applicationStorage = this._register(new storage_1.Storage(new storage_1.InMemoryStorageDatabase()));
        this.profileStorage = this._register(new storage_1.Storage(new storage_1.InMemoryStorageDatabase()));
...
function logStorage(application, profile, workspace, applicationPath, profilePath, workspacePath) {
    return __awaiter(this, void 0, void 0, function* () {
