...
import { ConfigurationTarget, IConfigurationChange, IConfigurationChangeEvent, IConfigurationData, IConfigurationModel, IConfigurationOverrides, IConfigurationUpdateOverrides, IConfigurationValue, IOverrides } from './configuration';
...
export declare class ConfigurationModel implements IConfigurationModel {
    ...
    inspect<V>(section: string | undefined, overrideIdentifier?: string | null): {
        value?: V;
        override?: V;
        merged?: V;
    };
