...
export declare namespace GitUtils {
     ...
     */
    function isBranchRename(arg: unknown): arg is Git.Options.BranchCommand.Rename;
    /**
     * `true` if the argument is an option for deleting an existing branch in the repository.
     */
    function isBranchDelete(arg: unknown): arg is Git.Options.BranchCommand.Delete;
    /**
     * `true` if the argument is an option for creating a new branch in the repository.
     */
    function isBranchCreate(arg: unknown): arg is Git.Options.BranchCommand.Create;
    /**
     * `true` if the argument is an option for listing the branches in a repository.
     */
    function isBranchList(arg: unknown): arg is Git.Options.BranchCommand.List;
    /**
     * `true` if the argument is an option for checking out a new local branch.
     */
    function isBranchCheckout(arg: unknown): arg is Git.Options.Checkout.CheckoutBranch;
    /**
     * `true` if the argument is an option for checking out a working tree file.
     */
    function isWorkingTreeFileCheckout(arg: unknown): arg is Git.Options.Checkout.WorkingTreeFile;
    /**
     * `true` if the argument is an error indicating the absence of a local Git repository.
     * Otherwise, `false`.
     */
    function isRepositoryDoesNotExistError(error: unknown): boolean;
    /**
