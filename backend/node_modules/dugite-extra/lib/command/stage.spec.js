    ...
    return __generator(this, function (_a) {
        ...
        describe('getStagedFiles', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 3:
                                ...
                                return [4 /*yield*/, (0, stage_1.unstage)(repositoryPath, toStage.filter(function (f) { return f.endsWith('A.txt'); }), 'HEAD', 'index')];
                            case 4:
                                _a.sent();
                                return [4 /*yield*/, (0, stage_1.getStagedFiles)(repositoryPath)];
                            case 5:
                ...
                it('reverting the state in the working tree should not modify the index state', function () { return __awaiter(void 0, void 0, void 0, function () {
                    var repositoryPath, stagedFiles, thePath, status, changedFiles, afterStatus, afterChangedFiles;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, (0, test_helper_1.createTestRepository)(track.mkdirSync())];
                ...
                it('reverting the state in the working tree state and index state by reset hard', function () { return __awaiter(void 0, void 0, void 0, function () {
                    var repositoryPath, stagedFiles, thePath, status, changedFiles, afterStatus, afterChangedFiles;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, (0, test_helper_1.createTestRepository)(track.mkdirSync())];
                            ...
                            case 3:
                                ...
                                thePath = (0, test_helper_1.modify)(repositoryPath, { path: 'A.txt', data: 'A\nModification in the index\nAnother modification in the working tree' })[0];
                                (0, chai_1.expect)(fs.readFileSync(path.join(repositoryPath, 'A.txt'), 'utf8')).to.be.deep.equal('A\nModification in the index\nAnother modification in the working tree');
                                return [4 /*yield*/, (0, stage_1.stage)(repositoryPath, (0, test_helper_1.add)(repositoryPath, { path: 'X.txt' }))];
                            case 4:
                                _a.sent();
                                return [4 /*yield*/, (0, status_1.getStatus)(repositoryPath)];
                            case 5:
                                status = _a.sent();
                                changedFiles = status.workingDirectory.files;
                                (0, chai_1.expect)(changedFiles).to.be.lengthOf(3);
                                (0, chai_1.expect)(changedFiles.map(function (f) { return f.path; })).to.deep.equal(['A.txt', 'A.txt', 'X.txt']);
                                (0, chai_1.expect)(changedFiles.map(function (f) { return f.staged; }).sort()).to.deep.equal([false, true, true]);
                                return [4 /*yield*/, (0, stage_1.unstage)(repositoryPath, thePath, 'HEAD', 'all')];
                            case 6:
                                _a.sent();
                                return [4 /*yield*/, (0, status_1.getStatus)(repositoryPath)];
                            case 7:
                                afterStatus = _a.sent();
                                afterChangedFiles = afterStatus.workingDirectory.files;
                                (0, chai_1.expect)(afterChangedFiles).to.be.lengthOf(0);
                                (0, chai_1.expect)(fs.readFileSync(path.join(repositoryPath, 'A.txt'), 'utf8')).to.be.deep.equal('A');
                                (0, chai_1.expect)(fs.existsSync(path.join(repositoryPath, 'X.txt'))).to.be.false;
                                return [2 /*return*/];
                        }
                    });
                }); });
